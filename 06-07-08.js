...
function crearClaseViajero() {
  class Viajero {
    ...
    addCompañero(nombre ='', nacionalidad ='', edad = 0) {
      ...
      // Tu código aca:
      this.compañeros.push({nombre : nombre, nacionalidad, edad})
    ...
    getCompañeros() {
      ...
      // Tu código aca:
      const nuevoArray = []
      for(var compa of this.compañeros){
        nuevoArray.push(compa.nombre)
      }
      return nuevoArray
    }
    ...
    getPromedioEdad() {
      ...
      // Tu código aca:
      var sumarEdad = 0
      for(let compa of this.compañeros){
        sumarEdad += compa.edad
      }
      return sumarEdad/this.compañeros.length
    }
  };
...
const carlos = new Viajero(
  'carlos', 26,
  ['belgica', 'estadosUnidos', 'islandia'],
  [
    {nombre: 'jhon', nacionalidad: 'australiano', edad:27},
    {nombre: 'peter', nacionalidad: 'belga', edad: 23},
  ]
)
carlos.addCompañero('jose', 'colombia', 22)
carlos.addPais('inglaterra')
